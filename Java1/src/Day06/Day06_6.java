...
///////////////////////////////////////////////////////////////////////////////////
					...
					System.out.println(" 알림)) 현 게시물 비밀번호 : " );  String password = scanner.next();
					if( boardlist[bno].password.equals(password) ) { // 게시물객체내 비밀번호 == 입력한 비밀번호 
						System.out.println(" 알림)) 수정할 제목을 입력해 주세요 ");
						System.out.print("제목: "); String ttl = scanner.next();
						boardlist[bno].title = ttl;
						System.out.println(" 알림)) 수정할 내용을 입력해 주세요 ");
						System.out.print("내용: "); String ctnt = scanner.next();
						boardlist[bno].content = ctnt;
