...
public class Book {
	...
	void 도서등록() {
		...
		// 1. 입력받아 
		System.out.println(" ISBN : ");	String isbn = Day07_5.scanner.next();
		System.out.println(" 도서명 : ");	String bname = Day07_5.scanner.next();
		System.out.println(" 작가 : ");	String bwriter = Day07_5.scanner.next();
		//*중복체크[isbn]
		for( Book temp : Day07_5.books ) {
